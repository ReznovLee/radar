...
if __name__ == "__main__":
    # 示例文件路径（需替换为实际路径）
    radar_csv = "scenario-2025-03-11/5-radar.csv"
    target_csv = "scenario-2025-03-11/10-targets_ballistic_missile.csv"
    save_image = "scenario-2025-03-11/scenario_visualization.png"
