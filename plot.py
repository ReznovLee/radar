...
if __name__ == "__main__":
    # 示例文件路径（需替换为实际路径）
    radar_csv = "output/scenario-2025-04-15/5-radar.csv"
    target_csv = "output/scenario-2025-04-15/10-targets.csv"
    save_image = "output/scenario-2025-04-15/scenario_visualization.png"
