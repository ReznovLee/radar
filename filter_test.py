...
def main():
    ...
    # 初始化测试器
    tester = FilterTester("output/scenario-2025-05-27/500-targets.csv")
    ...
    # --- 测试巡航导弹 ---
    true_pos_cm, est_pos_cm = tester.test_cruise_missile(51)
    ...
    # --- 测试飞机 ---
    true_pos_ac, est_pos_ac = tester.test_aircraft(251)
...
if __name__ == "__main__":
    main()
    test_param = Filter("output/scenario-2025-05-27/500-targets.csv")
    true_BM, perdit_BM = test_param.test_ballistic_missile(1)
    true_CM, perdit_CM = test_param.test_cruise_missile(51)
    true_AC, perdit_AC = test_param.test_aircraft(251)
    print(perdit_BM)
    print(perdit_CM)
    print(perdit_AC)
